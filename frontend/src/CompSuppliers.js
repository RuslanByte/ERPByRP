...
function CompSuppliers(){
  ...
  const handleCombinedClick = () => {
    ...
    <>
    <Left isRed={isBoxRed}/>
    <Suppliers handleCombinedClick={handleCombinedClick} gstyleTog = {gstyleTog} bstyleTog = {bstyleTog} onClickAdd = {toggleBoxHide} addstyleTog = {addstyleTog} linestyleTog = {linestyleTog}/>
    </>
    );
};

export default CompSuppliers;